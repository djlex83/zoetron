...
Stand: 6989 Neuronen · 450603 bewertete Synapsen
...
| 2 | 💭 | A single model provider (z-ai/glm-5.2) fails deterministically w… | 600 | 0.24 |
| 3 | 💭 | Model latency exhibits high variance (9‑85 s), frequently exceed… | 607 | 0.23 |
| 4 | 💭 | Repeated 429 errors on z-ai/glm-5.2:free indicate rate limiting … | 616 | 0.23 |
...
| 9 | 💭 | The nvidia/nemotron-3-ultra model succeeds where others fail but… | 491 | 0.27 |
| 10 | 💭 | The nvidia/nemotron-3-ultra-550b-a55b:free model is reliable but… | 508 | 0.26 |
| 11 | 💭 | nvidia/nemotron-3-ultra-550b:free consistently succeeds with acc… | 517 | 0.25 |
| 12 | 💭 | Model latency varies 50x (3.8–203 s) without a circuit breaker, … | 535 | 0.25 |
| 13 | 💭 | Same model (nemotron-3-super) shows 8x latency variance (4.4s to… | 530 | 0.24 |
| 14 | 💭 | The fallback model (nemotron-3-ultra) succeeds but exhibits 4x l… | 507 | 0.25 |
| 15 | 💭 | Nvidia Nemotron-3-Ultra is the only model returning successes bu… | 503 | 0.25 |
