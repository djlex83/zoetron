...
Stand: 5592 Neuronen · 301815 bewertete Synapsen
...
|---|---|---|---|---|
| 1 | 💭 | High latency variance (2.8s–83.8s) for same model shows need for… | 532 | 0.24 |
| 2 | 💭 | Model 429 errors cascade into fallback with 2-3x latency varianc… | 538 | 0.23 |
| 3 | 💭 | Model latency exhibits high variance (9‑85 s), frequently exceed… | 517 | 0.24 |
| 4 | 💭 | Repeated 429 errors on z-ai/glm-5.2:free indicate rate limiting … | 528 | 0.23 |
| 5 | 💭 | The primary model (glm-5.2) fails consistently with 429 rate lim… | 508 | 0.24 |
...
| 10 | 💭 | Same model (nemotron-3-super) shows 8x latency variance (4.4s to… | 449 | 0.25 |
| 11 | 💭 | nvidia/nemotron-3-ultra-550b:free consistently succeeds with acc… | 422 | 0.26 |
| 12 | 💭 | The nvidia/nemotron-3-ultra model succeeds where others fail but… | 401 | 0.27 |
| 13 | 💭 | The nvidia/nemotron-3-ultra-550b-a55b:free model is reliable but… | 410 | 0.26 |
