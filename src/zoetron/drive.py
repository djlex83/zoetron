...
class Drive:
    ...
    def generate_goals(self, n: int = 3) -> list[dict[str, Any]]:
        ...
        prompt = (
            ...
            "IMPORTANT: Write 'title' AND 'why' in simple, plain GERMAN "
            "so a non-technical human can understand what the goal "
            "means and why it matters. 'title' = max 8 words. "
            "'why' = 1-2 everyday-German sentences, no jargon.\n"
