  ...
  return (
    <Section id="zugang" className="border-t border-white/6">
      <div ref={root}>
        ...
        <div className="mt-14 grid gap-4 lg:mt-20 lg:grid-cols-3 lg:items-stretch">
          {tiers.map((tier) => (
            <article
              key={tier.key}
              data-tier
              data-reveal
              className={`panel relative flex flex-col panel-lg rounded-[20px] p-7 transition-transform duration-500 hover:-translate-y-1 sm:p-8 ${
            ...
            >
              {tier.featured && (
                <>
                  <div
                    className="pointer-events-none absolute inset-0 panel-lg rounded-[20px]"
              ...
              <div className="relative">
                ...
                <ul className="mt-7 space-y-3 border-t border-white/8 pb-8 pt-6">
              ...
              <a
                ...
                rel="noreferrer"
                className={`btn btn-hero mt-auto w-full ${tier.featured ? 'btn-solid' : 'btn-ghost'}`}
              >
                {t(tier.cta)}
              </a>
            </article>
